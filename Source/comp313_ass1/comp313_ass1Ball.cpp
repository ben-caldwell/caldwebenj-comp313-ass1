...
Acomp313_ass1Ball::Acomp313_ass1Ball()
{
	...
	Ball->BodyInstance.MassScale = 30.0f;
...
void Acomp313_ass1Ball::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// set up camera control bindings
	PlayerInputComponent->BindAxis("LookRight", this, &Acomp313_ass1Ball::AddControllerYawInput);
	PlayerInputComponent->BindAxis("LookUp", this, &Acomp313_ass1Ball::AddControllerPitchInput);
}
